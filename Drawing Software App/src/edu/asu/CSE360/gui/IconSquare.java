 ...
 *
 */
public class IconSquare extends ObservableIcon {		
    ...
    {
        System.out.println("\nSquare Icon Name Array : "+ iconName);
        System.out.println();
    }
    public void displayExtendName()
    {
        System.out.println("\nSquare Extend Name Array : "+ extendName);
        System.out.println();
    }
    public void displayImplementName()
    {
        System.out.println("\nSquare Implement Name Array : "+ implementName);
        System.out.println();
    }
	 ...
	 */
	public IconSquare(String text, int horizontalAlignment) {
	 ...
	 * @param horizontalAlignment
	 */
	public IconSquare(Icon image, int horizontalAlignment) {
	 ...
	 * @param horizontalAlignment
	 */
	public IconSquare(String text, Icon icon, int horizontalAlignment) {
		super(text, icon, horizontalAlignment);
		// TODO Auto-generated constructor stub
	}
      
    public void setTrustImplement(int trustImplement){
        this.trustImplement = trustImplement;
    }
    public int getTrustImplement(){
        return this.trustImplement;
    }
    /*public void addRowImplement(ArrayList<String> row){
        if(row.size() == trustImplement){
            implementName.add(row);
        }else{
            throw new IllegalArgumentException("Row isn't trusted. should contain values: "+ trustImplement);
        }
    }*/
    ...
    public String getAggrName(int row, int column) throws IllegalArgumentException {
        ...
        System.out.println("in getAggrName above the return!!");
